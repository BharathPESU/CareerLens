...
export default function CareerUpdatesPage() {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      // Success! The onSnapshot listener will pick up the new data automatically.
    } catch (err: any) {
        ...
        >
          <div>
            <div className="flex items-center gap-3">
              <div className="p-3 bg-gradient-to-br from-neon-cyan to-neon-purple rounded-xl shadow-neon-purple">
              ...
              <div>
                ...
                <p className="text-white/65">Real-time career updates powered by Google AI</p>
                {lastUpdate && (
          ...
          <button
            ...
            disabled={refreshing}
            className="px-4 py-2 bg-white/[0.08] hover:bg-white/[0.12] border border-white/20 rounded-full backdrop-blur-xl transition-all flex items-center gap-2 hover:scale-105 active:scale-95"
          >
